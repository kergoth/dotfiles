...
fpath=($ZSH/plugins/completions/src $ZSH/plugins/*/(N) $DOTFILESDIR/*/functions(N) $XDG_DATA_HOME/homebrews/*/share/zsh/site-functions(N) /opt/homebrew/share/zsh/site-functions $fpath)
