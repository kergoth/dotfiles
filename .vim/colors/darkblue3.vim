...
let colors_name = "darkblue3"

hi Normal		guifg=#c0c0c0 guibg=black						ctermfg=gray ctermbg=black
hi ErrorMsg		guifg=#ffffff guibg=#287eff						ctermfg=white ctermbg=lightblue
hi Visual		guifg=#8080ff guibg=fg		gui=reverse				ctermfg=lightblue ctermbg=fg cterm=reverse
hi VisualNOS	guifg=#8080ff guibg=fg		gui=reverse,underline	ctermfg=lightblue ctermbg=fg cterm=reverse,underline
hi Todo			guifg=#d14a14 guibg=black						ctermfg=red	ctermbg=black
hi Search		guifg=#90fff0 guibg=black						ctermfg=white ctermbg=black cterm=underline term=underline
