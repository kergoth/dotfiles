...
"
"============================================================================
" Source File: Id: iptables.src.vim,v 1.12 2006/03/11 22:10:26 ehaar Exp 
"============================================================================
...
syntax keyword iptablesLongParam
   \ --aaddr --add-set --addr --ahspi --algo --aname --and-mask --any-opt 
   \ --ashort --average --block-size --childlevel --chunk-types 
   ...
   \ --netlink --new --next --no-srr --nodst --numeric --oif --or-mask 
   \ --out-interface --packet --physdev-in --physdev-is-bridged 
   ...
   \ --restore-mark --rr --rttl --save-mark --seconds --set --set-class 
   \ --set-counters --set-dscp --set-dscp-class --set-mark --set-mss 
   \ --set-tos --sid-owner --smart --source --source-port --source-ports 
   \ --spi --sport --sports --src --src-range --src-type --ssrr --start 
   \ --state --strict --string --syn --table --tcp- --tcp-flags --tcp-option 
   \ --tee --timestart --timestop --to --to- --to-destination --to-ports 
   \ --to-source --tos --total-nodes --ts --ttl-dec --ttl-eq --ttl-gt 
   \ --ttl-inc --ttl-lt --ttl-set --tunnel-dst --tunnel-src --uid-owner 
   \ --ulog-cprange --ulog-nlgroup --ulog-prefix --ulog-qthreshold --update 
   \ --upper-limit --verbose
