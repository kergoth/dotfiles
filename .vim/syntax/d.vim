...
if exists("d_comment_strings")
  ...
  syn region dBlockComment	start="/\*"  end="\*/" contains=dBlockCommentString,@dCommentGroup,@Spell fold
  syn region dNestedComment	start="/+"  end="+/" contains=dNestedComment,dNestedCommentString,@dCommentGroup,@Spell fold
  syn match  dLineComment	"//.*" contains=dLineCommentString,@dCommentGroup,@Spell
else
  syn region dBlockComment	start="/\*"  end="\*/" contains=dBlockCommentString,@dCommentGroup,@Spell fold
  syn region dNestedComment	start="/+"  end="+/" contains=dNestedComment,dNestedCommentString,@dCommentGroup,@Spell fold
  syn match  dLineComment	"//.*" contains=dLineCommentString,@dCommentGroup,@Spell
