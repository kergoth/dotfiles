#!/usr/bin/env bash
# Claude Code status line — theme-aware (Dracula dark / Catppuccin Latte light) with rate limit pacing
...
# Detect terminal color scheme: "dark" or "light"
# Priority: CLITHEME env var > OSC 11 query > default dark
detect_theme() {
...
# Initialize palette for given theme (dark = Catppuccin Mocha, light = Catppuccin Latte)
# Args: $1 = "dark" or "light"
init_palette() {
    local theme="${1:-dark}"
    case "$theme" in
        light)
            # Catppuccin Latte
            COLOR_GREEN_BG=$'\033[48;2;64;160;43m'          # #40a02b
            ...
            COLOR_ACCENT_BG=$'\033[48;2;172;176;190m'       # #acb0be — surface2
        ...
        *)
            # Dracula (default)
            COLOR_GREEN_BG=$'\033[48;2;80;250;123m'        # #50fa7b
            ...
            COLOR_ACCENT_BG=$'\033[48;2;68;71;90m'         # #44475a — current line
...
# Default to dark palette when sourced (tests, etc.)
init_palette dark
