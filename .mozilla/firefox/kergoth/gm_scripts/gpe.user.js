...
{
    var preview;
    var button = getFirstElementMatchingClassName(entry,'span','item-preview');
...
{      
    ...
    try
    {
      location.href = 'javascript:void(u.U=-1);';
      location.href = 'javascript:void(u.nf('+index+'));';    
    }
    catch(err) {}
}      
