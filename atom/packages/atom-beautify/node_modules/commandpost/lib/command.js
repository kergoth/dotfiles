...
var Command = /** @class */ (function () {
        ...
        this.args = args.map(function (argStr) {
            if (findVariadic) {
                throw new error_1.CommandpostError({
                    ...
                    reason: error_1.ErrorReason.ParameterCantPlacedAfterVariadic,
                });
            }
            ...
            if (arg.required && findOptional) {
                throw new error_1.CommandpostError({
                    parts: [argStr],
                    message: "parameter can not placed after variadic parameter",
                    reason: error_1.ErrorReason.ParameterCannPlacedAfterOptional,
                });
            }
            if (!arg.required) {
                findOptional = true;
    ...
    Command.prototype._parseRawArgs = function (args) {
        ...
        if (this.unknownOptions.length !== 0 && !allowUnknownOption) {
            ...
            throw new error_1.CommandpostError({
                message: errMsg,
                reason: error_1.ErrorReason.UnknownOption,
