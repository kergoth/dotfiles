...
function requestData(provider, args, thisObj, timeout) {
    ...
    if (typeof provider === "function") {
        ...
        if (value !== undefined) {
            asyncValue.bB_(value);
        }
    } else {
        // Assume the provider is a data object...
        asyncValue.bB_(provider);
    }
    ...
    if (timeout > 0) {
        let timeoutId = setTimeout(function () {
            ...
            asyncValue.bA_(error);
        }, timeout);

        asyncValue.bz_(function () {
            if (timeoutId != null) {
...
module.exports = function awaitTag(input, out) {
    ...
    if (clientReorder) {
        ...
        clientReorderContext = out.global.bC_ || (out.global.bC_ = {
            instances: [],
            nextId: 0
        });
