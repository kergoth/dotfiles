...
_.extend(RemoteRevision.prototype, {
  ...
  getTemplate: function() {
    ...
    if (atom.config.get('git-blame-plus.useCustomUrlTemplateIfStandardRemotesFail')) {
      var customUrlTemplate = atom.config.get('git-blame-plus.customCommitUrlTemplateString');
