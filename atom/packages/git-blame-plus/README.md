#git-blame-plus
A fork of [git-blame](https://atom.io/packages/git-blame)
...
* **0.4.4**: Update package name
* **0.4.5**: [Issue #90](https://github.com/alexcorre/git-blame/issues/90) Fix missing `path` dependency
* **0.4.6**: Fix fork project configuration issue
